...
class WebRTCClient @Inject constructor(
    ...
    fun init(intent: Intent, listener: WebRTCListener) {
        ...
        peerConnection = webRTCManager.createPeerConnection(iceServers, object : MyPeerObserver() {
            override fun onIceCandidate(p0: IceCandidate?) {
                super.onIceCandidate(p0)
                p0?.let { sendIceCandidate(it, targetUser) }
            }
